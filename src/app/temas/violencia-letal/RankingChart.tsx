...
export function RankingChart({ top10, bottom5 }: Props) {
  return (
    <figure aria-label="Ranking dos estados por taxa de MVI por 100 mil habitantes em 2024">
      ...
      <figcaption className="sr-only">Ranking dos estados por taxa de MVI por 100 mil habitantes em 2024</figcaption>
    </figure>
  );
}
